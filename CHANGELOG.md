...
-  Fixes [#2703](https://github.com/microsoft/BotFramework-WebChat/issues/2703). Fixed carousal timestamp styling in iOS Safari, by [@tdurnford](https://github.com/tdurnford) in PR [#26xx](https://github.com/microsoft/BotFramework-WebChat/pull/26xx)
