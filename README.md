...
| [`04.c.display-character-limit`](https://github.com/Microsoft/BotFramework-WebChat/tree/master/samples/04.c.display-character-limit)                                       | Demonstrates how to set and display character limit for user messages.                                                                                                                                                      | [Demo](https://microsoft.github.io/BotFramework-WebChat/04.c.display-character-limit)                        |
